...
//
// The number of arguments accepted is either 0, or SQUFOF_F_MAX_ARGC-1
//
#define SQUFOF_F_MAX_ARGC 3
...
static void process_args(factoring_program_t* const program) {
    ...
    squfof_params_t* params = (squfof_params_t*) program->params;
    ...
    case 2: {
        //
        // Only one argument provided: the number to factor.
        //
...
static void set_params_to_default(factoring_program_t* const program) {
    set_squfof_params_to_default((squfof_params_t*) program->params);
}
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
static ecode_t squfof_func(mpz_array_t* const factors,
...
int main(int argc, char** argv) {
    ...
    program.verbose = TIFA_VERBOSE_SQUFOF;
    program.timing  = TIFA_TIMING_SQUFOF;
    ...
    program.factoring_algo_func        = squfof_func;
