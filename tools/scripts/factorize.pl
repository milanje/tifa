...
# Version : 2011-10-11
#
# The factorize.pl script is a very simple wrapper for the cfrac_program,
# qs_program, siqs_program and squfof_program programs. The script merely adds
...
$param_values{"conf"}    = "./factorize.conf";
...
if (defined $param_values{"numbers"}) {
    ...
    my $size_field = length($nb_numbers); # Size of the counter field in the
                                          # trace file's name
